    ...
    return (
      <div>
        ...
        {isLive ? <div>
          ...
          <p>Any claimant can make a claim, and claims can be made and managed online.</p>
        ...
        {!isLive && <div className="info">
          <h4>Currently</h4>
          {isComplex && <p>Single claimants, couples and families can make a claim online. Claimants must earn less than £338 per month, after tax.</p>}
          {!isComplex && <p>Only simple claims – from those who are single, and without children or a health condition – can be made. Claimants must earn less than £338 per month, after tax.</p>}
